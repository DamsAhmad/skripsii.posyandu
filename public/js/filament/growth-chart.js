document.addEventListener("DOMContentLoaded", function () {
    ...
    const whoCurves = {
        ...
        "-2": [
            2.4, 3.4, 4.3, 5.0, 5.6, 6.0, 6.4, 6.7, 6.9, 7.1, 7.4, 7.6, 7.7,
        ...
        "-1": [
            ...
            12.7, 12.8, 13.0, 13.1, 13.3, 13.4, 13.6, 13.7, 13.8, 14.0, 14.1,
            14.3, 14.4, 14.5, 14.7, 14.8, 15.0, 15.1, 15.2, 15.4, 15.5, 15.6,
            15.7, 15.9, 16.0,
        ],
        Median: [
            3.3, 4.5, 5.6, 6.4, 7.0, 7.5, 7.9, 8.3, 8.6, 8.9, 9.2, 9.4, 9.6,
            10.0, 10.1, 10.3, 10.5, 10.7, 10.9, 11.1, 11.3, 11.5, 11.8, 12.0,
        ...
        "+3": [
            4.9, 6.4, 7.8, 8.8, 9.6, 10.3, 10.8, 11.3, 11.8, 12.2, 12.6, 13.0,
            13.3, 13.7, 14.0, 14.3, 14.6, 15.0, 15.3, 15.6, 15.9, 16.2, 16.5,
            16.8, 17.1, 17.4, 17.7, 18.0, 18.3, 18.6, 18.9, 19.2, 19.5, 19.8,
            20.1, 20.4, 20.7, 21.0, 21.3, 21.6, 21.9, 22.2, 22.5, 22.8, 23.1,
            23.4, 23.7, 24.0, 24.3, 24.6, 24.9, 25.2, 25.5, 25.8, 26.1, 26.4,
            26.7, 27.0, 27.3, 27.6, 27.9,
        ],
    };
